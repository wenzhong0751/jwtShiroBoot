package com.shadow.springboot.application.shiro.token;

import com.shadow.springboot.application.util.AesUtil;
...
public class PasswordToken implements AuthenticationToken{
    ...
    private static final long serialVersionUID = 6282869188074462374L;
